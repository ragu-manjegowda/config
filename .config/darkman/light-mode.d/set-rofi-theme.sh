...
rofi_calc_config_path="$HOME/.config/awesome/configuration/rofi/calc/rofi.rasi"
sed -i -e "s#-dark#-light#g" $rofi_calc_config_path
...
sed -i -e "s#-dark#-light#g" $rofi_help_config_path
