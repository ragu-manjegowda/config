...
## Description  : Update neomutt mailboxes from mbsync for personal Gmail
###############################################################################

set -euo pipefail

CONFIG_DIR="${XDG_CONFIG_HOME:-$HOME/.config}/neomutt/accounts/personal"
CONFIG_FILES=("$CONFIG_DIR/raghudarshan")
MBSYNC_CONFIG="$CONFIG_DIR/mbsyncrc_raghudarshan"
