# Generated by Powerlevel10k configuration wizard on 2025-02-05 at 00:32 PST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    context                 # user@hostname (shows in SSH/root)
  ...
  # Truncate SSH context to 15 chars max (with ellipsis if longer)
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_CONTENT_EXPANSION='%15>…>%n@%m%<<'
